    ...
    private void showData(Map<String, Object> dataSnapshot) {
        ...
        mListViewKurir.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Transaksi newTransaksi = new Transaksi(userID + ts, userID, userID + ts, Id_Kurir, Lat_Penerima, Lng_Penerima, Lat_Donatur, Lng_Donatur, NamaDonatur, NamaKurir, NamaPenerima, Barang, Kuantitas);
