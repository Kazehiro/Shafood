...
public class Daftar_Kurir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_kurir);
        ...
        btnTambahKurir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nama.equals("")) {
                    ...
                    Intent i = new Intent(Daftar_Kurir.this, Berhasil.class);
                    startActivity(i);
                }
    ...
    public void onComplete(@NonNull Task<AuthResult> task) {
        ...
        if(task.isSuccessful()) {
            ...
            Toast.makeText(Daftar_Kurir.this, "Successfully registered "+spPilih.getSelectedItem(), Toast.LENGTH_LONG).show();
            if (spPilih.getSelectedItem().toString().equals("Donatur")) {
                Intent register = new Intent(Daftar_Kurir.this, Daftar_donatur.class);
                startActivity(register);
            }
            else if(spPilih.getSelectedItem().toString().equals("Kurir")){
                Intent register = new Intent(Daftar_Kurir.this, Daftar_Kurir.class);
                startActivity(register);
            }
            else if(spPilih.getSelectedItem().toString().equals("Penerima")){
                Intent register = new Intent(Daftar_Kurir.this, Daftar_penerima.class);
                startActivity(register);
            }
            else{
                Toast.makeText(Daftar_Kurir.this,"Pilih Level",Toast.LENGTH_LONG).show();
            }
        }
        else{
            //display some message here
            Toast.makeText(Daftar_Kurir.this,"Registration Error",Toast.LENGTH_LONG).show();
        }
    }
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (items[i].equals("Camera")) {
                    EasyImage.openCamera(Daftar_Kurir.this, REQUEST_CODE_CAMERA_IDENTITAS);
                } else if (items[i].equals("Gallery")) {
                    EasyImage.openGallery(Daftar_Kurir.this, REQUEST_CODE_GALLERY_IDENTITAS);
                }
            }
        });
    ...
    private void chooseImageSTNK() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (items[i].equals("Camera")) {
                    EasyImage.openCamera(Daftar_Kurir.this, REQUEST_CODE_CAMERA_STNK);
                } else if (items[i].equals("Gallery")) {
                    EasyImage.openGallery(Daftar_Kurir.this, REQUEST_CODE_GALLERY_STNK);
                }
            }
        });
        AlertDialog dialog = builder.create();
    ...
    private void chooseImageSIM() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (items[i].equals("Camera")) {
                    EasyImage.openCamera(Daftar_Kurir.this, REQUEST_CODE_CAMERA_SIM);
                } else if (items[i].equals("Gallery")) {
                    EasyImage.openGallery(Daftar_Kurir.this, REQUEST_CODE_GALLERY_SIM);
                }
            }
        });
        AlertDialog dialog = builder.create();
            ...
            ref.putFile(filePath1)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(Daftar_Kurir.this, "Uploaded Berhasil", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(Daftar_Kurir.this, "Upload Gagal " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
